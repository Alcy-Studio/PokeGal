...
#import "PGTalkViewController+IB.h"
#import "Think.h"
#import "Think+Act.h"
...
@implementation PGTalkViewController(IB)
...
- (IBAction) touchUpInside:(id)sender{
	 ...
	 */
	Think *think = [[Think alloc] initWithScene:kSceneCodePGTalk tag:[sender tag] event: kEventCodeTouchUpInside];
	if (![think act])
