//
//  PGTutorPageViewController+IB.m
//  PocketDraft
//
...
#import "PGTutorPageViewController+IB.h"
#import "Think.h"
#import "Think+Act.h"
...
@implementation PGTutorPageViewController(IB)
...
- (IBAction) touchUpInside:(id)sender{
	 ...
	 */
	Think *think = [[Think alloc] initWithScene:kSceneCodePGTutorPage tag:[sender tag] event: kEventCodeTouchUpInside];
	if (![think act])
