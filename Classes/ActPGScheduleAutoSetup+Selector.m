...
@interface ActPGScheduleAutoSetup()
...
-(void)setViewTopTitle{
	[(UILabel*)[[(PGScheduleViewController*)self.resource view] viewWithTag:kScheduleViewTitle] 
	 setText:NSLocalizedString(kScheduleTitleText,  @"Localized")];
