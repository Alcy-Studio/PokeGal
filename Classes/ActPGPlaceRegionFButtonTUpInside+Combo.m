//
//  ActPGPlaceRegionFButtonTUpInside+Combo.m
//  frdfrd
//
...
#import "ActPGPlaceRegionFButtonTUpInside+Combo.h"


@implementation ActPGPlaceRegionFButtonTUpInside(Combo)


-(void)setComboRegionButton{
	NSLog(@"ActPGPlaceRegionFButtonTUpInside - setComboRegionButton");
