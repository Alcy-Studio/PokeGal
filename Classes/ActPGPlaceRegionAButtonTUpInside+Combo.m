//
//  ActPGPlaceRegionAButtonTUpInside+Combo.m
//  frdfrd
//
...
@implementation ActPGPlaceRegionAButtonTUpInside(Combo)


-(void)setComboRegionButton{
	NSLog(@"ActPGPlaceRegionAButtonTUpInside - setComboRegionButton");
