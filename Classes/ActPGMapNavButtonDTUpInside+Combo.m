//
//  ActPGMapNavButtonDTUpInside+Combo.m
//  PocketDraft
//
...
#import "ActPGMapNavButtonDTUpInside+Combo.h"


@implementation ActPGMapNavButtonDTUpInside(Combo)

-(void)setComboNavButtonD{
	NSLog(@"ActPGMapNavButtonDTUpInside - SetComboNavButtonD");
