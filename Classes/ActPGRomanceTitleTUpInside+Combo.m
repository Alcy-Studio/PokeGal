//
//  ActPGRomanceTitleTUpInside+Combo.m
//  PocketDraft
//
...
//Additional
#import "ActPGRomanceTitleTUpInside+Selector.h"
@implementation ActPGRomanceTitleTUpInside(Combo)

-(void)setCombo{
	NSLog(@"ActPGRomanceTitleTUpInside - setComboHelp");
