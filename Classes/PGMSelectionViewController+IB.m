//
//  PGMSelectionViewController+IB.m
//  PocketDraft
//
...
#import "PGMSelectionViewController+IB.h"
#import "Think.h"
#import "Think+Act.h"
...
@implementation PGMSelectionViewController(IB)
...
- (IBAction) touchUpInside:(id)sender{
	 ...
	 */
	Think *think = [[Think alloc] initWithScene:kSceneCodePGMSelection tag:[sender tag] event: kEventCodeTouchUpInside resource:self];
	if (![think act])
