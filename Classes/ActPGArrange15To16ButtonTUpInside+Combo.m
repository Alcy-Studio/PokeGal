//
//  ActPGArrange15To16ButtonTUpInside+Combo.m
//  PocketDraft
//
...
@implementation ActPGArrange15To16ButtonTUpInside(Combo)

-(void)setComboAvailableButton{
	NSLog(@"ActPGArrange15To16ButtonTUpInside - SetComboAvailableButton");
...
-(void)setComboOccupiedButton{
	NSLog(@"ActPGArrange15To16ButtonTUpInside - SetComboOccupiedButton");
