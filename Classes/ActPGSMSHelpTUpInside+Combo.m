...
//Additional
#import "ActPGSMSHelpTUpInside+Selector.h"
@implementation ActPGSMSHelpTUpInside(Combo)

-(void)setComboHelp{
	NSLog(@"ActPGSMSHelpTUpInside - setComboHelp");
