...
@interface PGDateSVController (PrivateMethods)
...
@implementation PGDateSVController
...
- (void)viewDidLoad {
	...
	//PGDateViewController *vc2 = [[PGDateViewController alloc] initWithPageNumber:kSVPage2];
	PGDateViewController *vc2 = [[PGDateViewController alloc] init];
	...
	vc2.title = @"PGDateViewController";
	...
	//[(PGDateViewController*)[viewControllers objectAtIndex:kSVPage2] autoSetup];
...
- (void)loadScrollViewWithPage:(int)page {
	...
	//PGDateViewController *c2 = [viewControllers objectAtIndex:page];
    ...
    if (nil == controller.view.superview) {
		...
		switch (page) {
			...
			case kSVPage2:
				[scrollView addSubview: 
				 ((PGDateViewController*)[viewControllers objectAtIndex:page]).view];
				break;
			case kSVPage3:
				[scrollView addSubview: 
...
- (void)viewDidUnload {
    [super viewDidUnload];
    // Release any retained subviews of the Date view.
