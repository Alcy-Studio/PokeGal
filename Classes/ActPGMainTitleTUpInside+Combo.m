//
//  ActPGMainTitleTUpInside+Combo.m
//  PocketDraft
//
...
//Additional
#import "ActPGMainTitleTUpInside+Selector.h"
@implementation ActPGMainTitleTUpInside(Combo)

-(void)setCombo{
	NSLog(@"ActPGMainTitleTUpInside - setComboHelp");
