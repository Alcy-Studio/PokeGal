//
//  ActPGAttrGKButtonTUpInside+Selector.m
//  PocketDraft
//
...
#import "ActPGAttrGKButtonTUpInside+Selector.h"
...
@implementation ActPGAttrGKButtonTUpInside(Selector)
...
-(void)presentModalGameCenter{
	...
	if ([[GKLocalPlayer localPlayer] isAuthenticated]) {
		[MGame showLeaderboard:self.resource];
		return;
	}
...
//
//-(void)setTmpAction{
//	[MUi modifyUserDefaultWithKey:kTmpAction value:kTmpActionPGAttrGKButton];
//	
//}
//
