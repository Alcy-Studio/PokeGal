...
//Repo
#import "MAct.h"
@interface PGMainSVController (PrivateMethods)
...
@implementation PGMainSVController
...
- (void)viewDidLoad {
	...
	//PGMainViewController *vc2 = [[PGMainViewController alloc] initWithPageNumber:kSVPage2];
	PGMainViewController *vc2 = [[PGMainViewController alloc] init];
	...
	vc2.title = @"PGMainViewController";
	...
	//[(PGMainViewController*)[viewControllers objectAtIndex:kSVPage2] autoSetup];
...
- (void)loadScrollViewWithPage:(int)page {
	...
	//PGMainViewController *c2 = [viewControllers objectAtIndex:page];
    ...
    if (nil == controller.view.superview) {
		...
		switch (page) {
			...
			case kSVPage2:
				[scrollView addSubview: 
				 ((PGMainViewController*)[viewControllers objectAtIndex:page]).view];
				break;
			case kSVPage3:
				[scrollView addSubview: 
