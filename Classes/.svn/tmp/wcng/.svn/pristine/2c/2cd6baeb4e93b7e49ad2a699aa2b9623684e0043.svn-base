//
//  ActPGPlaceRegionCButtonTUpInside+Combo.m
//  frdfrd
//
...
#import "ActPGPlaceRegionCButtonTUpInside+Combo.h"


@implementation ActPGPlaceRegionCButtonTUpInside(Combo)


-(void)setComboRegionButton{
	NSLog(@"ActPGPlaceRegionCButtonTUpInside - setComboRegionButton");
