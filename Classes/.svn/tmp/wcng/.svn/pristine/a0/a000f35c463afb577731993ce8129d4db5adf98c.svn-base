//
//  ActPGMapNavButtonATUpInside+Combo.m
//  PocketDraft
//
...
@implementation ActPGMapNavButtonATUpInside(Combo)

-(void)setComboNavButtonA{
	NSLog(@"ActPGMapNavButtonATUpInside - SetComboNavButtonA");
