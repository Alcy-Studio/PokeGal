//
//  ActPGPlaceRegionIButtonTUpInside+Combo.m
//  frdfrd
//
...
#import "ActPGPlaceRegionIButtonTUpInside+Combo.h"


@implementation ActPGPlaceRegionIButtonTUpInside(Combo)


-(void)setComboRegionButton{
	NSLog(@"ActPGPlaceRegionIButtonTUpInside - setComboRegionButton");
