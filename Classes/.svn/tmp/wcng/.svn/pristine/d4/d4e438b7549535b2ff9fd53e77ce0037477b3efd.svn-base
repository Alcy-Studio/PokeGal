//
//  ActPGAchiULButtonTUpInside+Selector.m
//  PocketDraft
//
...
#import "ActPGAchiULButtonTUpInside+Selector.h"
...
@implementation ActPGAchiULButtonTUpInside(Selector)
...
-(void)setHintWithGiftDescriptionNone{
	NSString* s = [MLoad getContentWithAttr1:[NSNumber numberWithInt:kModelGeneralScenePGAchi] 
									   ...
									   Attr3:[NSNumber numberWithInt:kModelTextOutKindGiftHint1] 
									  Entity:kGlossaryTextOut
										 Key:kGlossaryContent];
	if (!s){
		NSLog(@"ActPGAchiULButtonTUpInside - setHintWithGiftDescriptionNone");	
		return;
	}
...
-(void)setMsgWithGiftDescriptionOn{
	NSString* s = [MLoad getContentWithAttr1:[NSNumber numberWithInt:kModelGeneralScenePGAchi] 
									   Attr2:[NSNumber numberWithInt:kModelTextOutInfoGift] 
									   Attr3:[NSNumber numberWithInt:kModelTextOutKindGiftNote1] 
									  Entity:kGlossaryTextOut
										 Key:kGlossaryContent];
	if (!s){
