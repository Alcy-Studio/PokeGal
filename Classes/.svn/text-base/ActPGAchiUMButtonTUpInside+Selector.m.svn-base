//
//  ActPGAchiUMButtonTUpInside+Selector.m
//  PocketDraft
//
...
#import "ActPGAchiUMButtonTUpInside+Selector.h"
...
@implementation ActPGAchiUMButtonTUpInside(Selector)
...
-(void)setHintWithGiftDescriptionNone{
	NSString* s = [MLoad getContentWithAttr1:[NSNumber numberWithInt:kModelGeneralScenePGAchi] 
									   ...
									   Attr3:[NSNumber numberWithInt:kModelTextOutKindGiftHint2] 
									  Entity:kGlossaryTextOut
										 Key:kGlossaryContent];
	if (!s){
		NSLog(@"ActPGAchiUMButtonTUpInside - setHintWithGiftDescriptionNone");	
		return;
	}
...
-(void)setMsgWithGiftDescriptionOn{
	NSString* s = [MLoad getContentWithAttr1:[NSNumber numberWithInt:kModelGeneralScenePGAchi] 
									   Attr2:[NSNumber numberWithInt:kModelTextOutInfoGift] 
									   Attr3:[NSNumber numberWithInt:kModelTextOutKindGiftNote2] 
									  Entity:kGlossaryTextOut
										 Key:kGlossaryContent];
	if (!s){
