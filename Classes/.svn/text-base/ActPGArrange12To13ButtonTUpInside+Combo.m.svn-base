//
//  ActPGArrange12To13ButtonTUpInside+Combo.m
//  PocketDraft
//
...
@implementation ActPGArrange12To13ButtonTUpInside(Combo)

-(void)setComboAvailableButton{
	NSLog(@"ActPGArrange12To13ButtonTUpInside - SetComboAvailableButton");
...
-(void)setComboOccupiedButton{
	NSLog(@"ActPGArrange12To13ButtonTUpInside - SetComboOccupiedButton");
