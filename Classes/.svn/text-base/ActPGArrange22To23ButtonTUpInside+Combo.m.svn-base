//
//  ActPGArrange22To23ButtonTUpInside+Combo.m
//  PocketDraft
//
...
@implementation ActPGArrange22To23ButtonTUpInside(Combo)

-(void)setComboAvailableButton{
	NSLog(@"ActPGArrange22To23ButtonTUpInside - SetComboAvailableButton");
...
-(void)setComboOccupiedButton{
	NSLog(@"ActPGArrange22To23ButtonTUpInside - SetComboOccupiedButton");
