//
//  ActPGMapNavButtonBTUpInside+Combo.m
//  PocketDraft
//
...
@implementation ActPGMapNavButtonBTUpInside(Combo)

-(void)setComboNavButtonB{
	NSLog(@"ActPGMapNavButtonBTUpInside - SetComboNavButtonB");
