//
//  ActPGPlaceRegionDButtonTUpInside+Combo.m
//  frdfrd
//
...
@implementation ActPGPlaceRegionDButtonTUpInside(Combo)


-(void)setComboRegionButton{
	NSLog(@"ActPGPlaceRegionDButtonTUpInside - setComboRegionButton");
