//
//  ActPGMapNavButtonETUpInside+Combo.m
//  PocketDraft
//
...
#import "ActPGMapNavButtonETUpInside+Combo.h"


@implementation ActPGMapNavButtonETUpInside(Combo)

-(void)setComboNavButtonE{
	NSLog(@"ActPGMapNavButtonETUpInside - SetComboNavButtonE");
