//
//  ActPGMapNavButtonCTUpInside+Combo.m
//  PocketDraft
//
...
@implementation ActPGMapNavButtonCTUpInside(Combo)

-(void)setComboNavButtonC{
	NSLog(@"ActPGMapNavButtonCTUpInside - SetComboNavButtonC");
