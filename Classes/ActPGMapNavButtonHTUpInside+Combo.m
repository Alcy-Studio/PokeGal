//
//  ActPGMapNavButtonHTUpInside+Combo.m
//  PocketDraft
//
...
#import "ActPGMapNavButtonHTUpInside+Combo.h"


@implementation ActPGMapNavButtonHTUpInside(Combo)

-(void)setComboNavButtonH{
	NSLog(@"ActPGMapNavButtonHTUpInside - SetComboNavButtonH");
