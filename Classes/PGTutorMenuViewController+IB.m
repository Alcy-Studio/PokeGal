//
//  PGTutorMenuViewController+IB.m
//  PocketDraft
//
...
#import "PGTutorMenuViewController+IB.h"
#import "Think.h"
#import "Think+Act.h"
...
@implementation PGTutorMenuViewController(IB)
...
- (IBAction) touchUpInside:(id)sender{
	 ...
	 */
	Think *think = [[Think alloc] initWithScene:kSceneCodePGTutorMenu tag:[sender tag] event: kEventCodeTouchUpInside];
	if (![think act])
