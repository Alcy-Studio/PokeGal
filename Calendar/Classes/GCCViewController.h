...
/*
 GCCViewController defines the top-level view controller containing
 ...
 */
@interface GCCViewController : GCCalendarView <GCCalendarDataSource, GCCalendarDelegate>{
...
@property (nonatomic, retain) GCDatePickerControl* dayPicker;
